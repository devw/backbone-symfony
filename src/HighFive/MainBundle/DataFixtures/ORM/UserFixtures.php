...
use HighFive\MainBundle\Util\NameGuesser;
...
class UserFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    {
        /** @var $organization \HighFive\MainBundle\Entity\Organization */
        $organization = $this->getReference('organization');
        /** @var $organization2 \HighFive\MainBundle\Entity\Organization */
